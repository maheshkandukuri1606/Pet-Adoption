		...
		<nav class="navbar navbar-expand-md navbar-light fixed-top bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="nav nav-pills" id="pills-tab" role="tablist">
					...
					<li class="nav-item"><a class="nav-link" id="pills-status-tab"
						href="${pageContext.request.contextPath}/status?id=${param.id}">Status </a></li>
		...
		<main role="main" class="container-fluid">
			<div class="tab-content" id="pills-tabContent">
				...
				<div class="tab-pane fade show active" id="pills-home"
					...
					<%-- <form:form
								action="${pageContext.request.contextPath}/reqAnimal?id=${param.id}&animalId=${aniaml.getId()}"
								method="POST"> --%>
					<table>
						<tr>
							<th>Owner Id</th>
						...
						<c:forEach var="animal" items="${requestScope.animal}">
							...
							<tr>
								...
								<td><a class="btn btn-primary" id="${animal.getId()}"
									href="${pageContext.request.contextPath}/reqAnimal?userId=${param.id}&animalId=${animal.getId()}">Request
								</a></td>
							</tr>
	...
	<script>
		...
		$(".req-btn").on(
				...
				function() {
					...
					xhttp.open("POST",
							"http://localhost:8080/petadoption/reqAnimal?userId="
									+ userId + "&animalId=" + animalId, true);
					xhttp.send();
